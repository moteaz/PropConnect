    ...
    <section className="py-24 bg-gradient-to-br from-violet-600 via-indigo-600 to-purple-700 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/signup"
            className="bg-white text-violet-600 px-10 py-4 rounded-xl font-bold text-lg hover:bg-violet-50 transition-all shadow-2xl hover:shadow-3xl hover:scale-105"
          >
            Get Started Free
          </Link>
          <Link
            href="/login"
            className="bg-white/10 backdrop-blur-sm border-2 border-white text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-violet-600 transition-all hover:scale-105"
          >
            List Your Property
          </Link>
        </div>
